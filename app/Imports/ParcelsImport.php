        ...
        foreach ($rows as $row){
            ...
            if (Sentinel::getUser()->user_type == 'merchant' || Sentinel::getUser()->user_type == 'merchant_staff'):
                ...
                if (settingHelper('preferences')->where('title','outside_dhaka')->first()->merchant):
                    array_push($available_parcel_types, 'outside_dhaka');
                endif;
            else:
            ...
            elseif($parcel_type == "sub_city"):
                $location            = 'sub_city';
            elseif($parcel_type == "outside_dhaka"):
            ...
            $parcel = Parcel::create([
                'parcel_no'           => 'MVX'.rand(10000000000,99999999999),
                ...
                'pickup_hub_id'             => $row['pickup_hub'] ?? ($merchant->user->hub_id !='' ?$merchant->user->hub_id : null),

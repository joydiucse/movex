                        ...
                        <div class="nk-block-between">
                            ...
                            <div class="nk-block-head-content">
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    ...
                                    <a href="{{ route('create-return-batch') }}" class="btn btn-primary  d-md-inline-flex"><em class="icon ni ni-edit"></em><span>{{__('create_batch')}}</span></a>
                                </div><!-- .toggle-wrap -->
                            </div><!-- .nk-block-head-content -->
                                            ...
                                            <div class="nk-tb-col">
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td class="tb-lead">Processed Date: {{ $assign->updated_at->format('Y-m-d') }} </td>
                                                    </tr>
                                                </table>
                                            </div>

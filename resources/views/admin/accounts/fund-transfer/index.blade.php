                    ...
                    <div class="nk-block-between">
                        ...
                        <div class="nk-block-head-content">
                            @if(hasPermission('fund_transfer_create'))
                                <a href="{{route('admin.fund-transfer.create')}}" class="btn btn-primary d-md-inline-flex"><em class="icon ni ni-plus"></em><span>{{__('add')}}</span></a>
                            @endif
                        </div><!-- .nk-block-head-content -->
                        ...
                        <div class="card-inner-group">
                            ...
                            <div class="card-inner p-0">
                                <div class="nk-tb-list nk-tb-ulist">
                                    ...
                                    <div class="nk-tb-item" id="row_{{$fund_transfer->id}}">
                                        <div class="nk-tb-col">
                                            <span>{{$key + 1}}</span>
                                        </div>
                                        ...
                                        <div class="nk-tb-col">
                                            <span>{{number_format($fund_transfer->amount,2)}}</span>
                                        </div>
                                                        ...
                                                        <div class="drodown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <ul class="link-list-opt no-bdr">
                                                                    ...
                                                                    <li><a href="{{route('admin.fund-transfer.edit', $fund_transfer->id)}}"><em class="icon ni ni-edit"></em> <span> {{__('edit')}}</span></a></li>
                                                                    @endif
                                                                    @if(hasPermission('fund_transfer_delete'))
                                                                    <li><a href="javascript:void(0);" onclick="delete_row('fund-transfer-delete/', {{$fund_transfer->id}})" id="delete-btn"><em class="icon ni ni-trash"></em> <span> {{__('delete')}} </span></a></li>
                                                                    @endif
                                                                </ul>
                                                            </div>
                                                        </div>

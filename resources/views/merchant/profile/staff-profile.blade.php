                                ...
                                <div class="card-inner card-inner-lg">
                                    <div class="nk-block-head nk-block-head-lg">
                                        <div class="nk-block-between">
                                            ...
                                            <div class="d-flex">
                                                <button data-id="{{ \Sentinel::getUser()->id }}"
                                                    class="delete-btn btn btn-danger d-md-inline-flex mr-2"><em
                                                        class="icon ni ni-trash"></em><span>{{ __('delete') }}</span></button>
                                                <a href="#" data-toggle="modal" data-target="#update-profile"
                                                    class="btn btn-primary d-md-inline-flex"><em
                                                        class="icon ni ni-edit"></em><span>{{ __('edit') }}</span></a>
                                        ...
                                        <div class="nk-data data-list">
                                            ...
                                            <div class="data-item" data-toggle="modal" data-target="#profile-edit">
                                                <div class="data-col">
                                                    ...
                                                    <span
                                                        class="data-value">{{ \Sentinel::getUser()->first_name . ' ' . \Sentinel::getUser()->last_name }}</span>
                                                </div>
                                            </div><!-- data-item -->
                                            ...
                                            <div class="data-item">
                                                <div class="data-col">
                                                    <span class="data-label">{{ __('phone_number') }}</span>
                                                    <span
                                                        class="data-value">{{ \Sentinel::getUser()->phone_number }}</span>
                                                </div>
                                            </div><!-- data-item -->
                                            <div class="data-item">
                                                <div class="data-col">
                                            ...
                                            <div class="data-item">
                                                <div class="data-col">
                                                    ...
                                                    <span
                                                        class="data-value">{{ \Sentinel::getUser()->last_login != '' ? date('M y, Y h:i a', strtotime(\Sentinel::getUser()->last_login)) : '' }}</span>
                                                </div>
                                            </div><!-- data-item -->
                                        </div><!-- data-list -->
                                    </div><!-- .nk-block -->

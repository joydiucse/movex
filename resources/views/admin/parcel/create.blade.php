                                        ...
                                        <div class="col-md-12">
                                            <div class="card-inner">
                                                <div class="row g-gs">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <select id="merchant-live-search" name="merchant" class="form-control form-control-lg select-merchant merchant merchant-live-search" data-url="{{ route('merchant.change') }}" required>
                                                                    ...
                                                                    <option value="{{ @$parcel->merchant->id }}" {{@$parcel->merchant->id != null  ? 'selected':''}}>{{ @$parcel->merchant->user->first_name.' '.@$parcel->merchant->user->last_name }} ({{@$parcel->merchant->company}})</option>
                                                                </select>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="form-label" for="area">{{__('shop').' ('.__('select_merchant_first')}}) </label>
                                                            <div class="form-control-wrap">
                                                ...
                                                <div class="row g-gs">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="number" class="form-control cash-collection" id="fv-full-name" value="{{ old('price') != ""? old('price'):@$parcel->price }}" name="price" placeholder="{{__('cash_amount_including_delivery_charge')}}" required>
                                                            </div>
                                                            @if($errors->has('price'))
                                                                <div class="nk-block-des text-danger">
                                                ...
                                                <div class="row g-gs">
                                                    ...
                                                    <div class="col-md-3 packaging-area  {{isset($parcel)? ($parcel->fragile == 0? 'd-none':''):'d-none'}}">
                                                        <div class="form-group">

        ...
        <div class="container-fluid">
            <div class="nk-content-inner">
                <div class="nk-content-body">
                    ...
                    <form action="{{ route('merchant.staff.update')}}" class="form-validate" method="POST" enctype="multipart/form-data">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @foreach(Sentinel::getUser()->merchant->shops as $shop)
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input read" id="shop-{{ $shop->id }}" name="shops[]" value="{{ $shop->id }}" required {{in_array($shop->id, $staff->shops)? 'checked':''}}>

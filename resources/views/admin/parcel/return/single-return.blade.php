    ...
    <div class="modal fade" tabindex="-1" id="returned-to-merchant">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                     {{-- message-area --}}
                    <div class="alert alert-success alert-dismissible fade show text-dark message-box" style="display: none">
                    ...
                    <form action="{{route('parcel-returned-to-merchant')}}" method="POST" class="form-validate is-alter">
                        ...
                        @if(hasPermission('parcel_returned_to_merchant'))
                            <div class="row">
                                    <div class="col-md-3">
                                        <button type="button" class="btn btn-sm btn-primary  mt-1 otp-button" onclick="sendOTPCode()">Send OTP</button>
                                    </div>

                                    <div class="col-md-1 mt-1">
                                        <span class="countdown" style="visibility: hidden;">120</span>
                                    </div>
                            </div>
                        @endif
                        ...
                        @if(hasPermission('parcel_returned_to_merchant'))
                            <div class="form-group text-right">
                                <button type="submit" disabled class="btn btn-lg btn-primary resubmit merchant_return_btn">{{__('submit')}}</button>
                            </div>
                        @endif
                    </form>
                </div>

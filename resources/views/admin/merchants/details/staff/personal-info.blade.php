                            ...
                            <div class="card-inner card-inner-lg">
                                <div class="nk-block-head nk-block-head-lg">
                                    <div class="nk-block-between">
                                        ...
                                        <div class="d-flex">
                                            <a href="{{route('detail.merchant.staff.edit', $staff->id)}}"  class="btn btn-primary d-md-inline-flex"><em class="icon ni ni-edit"></em><span>{{__('edit')}}</span></a>
                                    ...
                                    <div class="nk-data data-list">
                                        ...
                                        <div class="data-item" data-toggle="modal" data-target="#profile-edit">
                                            <div class="data-col">
                                                ...
                                                <span class="data-value">{{$staff->first_name.' '.$staff->last_name}}</span>
                                            </div>
                                        </div><!-- data-item -->
                                        ...
                                        <div class="data-item">
                                            <div class="data-col">
                                                ...
                                                <span class="data-value">{{$staff->phone_number}}</span>
                                            </div>
                                        </div><!-- data-item -->
                                        <div class="data-item">
                                            <div class="data-col">
                                        ...
                                        <div class="data-item">
                                            <div class="data-col">
                                                ...
                                                <span class="data-value">{{$staff->last_login != ""? date('M y, Y h:i a', strtotime($staff->last_login)):''}}</span>
                                            </div>
                                        </div><!-- data-item -->
                                    </div><!-- data-list -->
                                </div><!-- .nk-block -->

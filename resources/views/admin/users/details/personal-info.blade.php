                                    ...
                                    <div class="nk-data data-list">
                                        ...
                                        <div class="data-item">
                                            <div class="data-col">
                                                ...
                                                <span class="data-value">{{$user->last_login != ""? date('M y, Y h:i a', strtotime($user->last_login)):''}}</span>
                                            </div>
                                        </div><!-- data-item -->
                                        <div class="data-item">
                                            <div class="data-col">
                                                <span class="data-label">{{__('hub')}}</span>
                                                <span class="data-value"> {{@$user->hub ? $user->hub->name.' ('.$user->hub->address.')':''}}</span>
                                            </div>
                                        </div><!-- data-item -->
                                    </div><!-- data-list -->
                                </div><!-- .nk-block -->

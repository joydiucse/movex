                        ...
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                ...
                                <div class="nk-block-des text-soft">
                                    <p>{{__('you_have_total')}} {{ $parcels->total() }} {{__('return_merrchant')}}.</p>
                                </div>
                        ...
                        <div class="card card-stretch">
                            <div class="card-inner-group">
                                <div class="card-inner position-relative card-tools-toggle">
                                    ...
                                    <form action="{{route('merchant.parcel.return-list')}}" method="GET">
                                        <div class="row g-gs">
                                            <div class="col-md-2">
                                    ...
                                    <div class="nk-tb-list nk-tb-ulist">
                                        ...
                                        <div class="nk-tb-item">
                                            ...
                                            <div class="nk-tb-col">
                                                ...
                                                <table>
                                                    <tr> <td class="tb-lead">Phone Number : {{ $parcel->merchant->phone_number ?? '' }}</td></tr>
                                                    <tr> <td class="tb-lead">Address : {{ $parcel->merchant->address ?? '' }}</td></tr>
                                            ...
                                            <div class="nk-tb-col nk-tb-col-tools">
                                                <ul class="nk-tb-actions gx-1">
                                                    <li><a href="{{ route('merchant.parcel.return-list.view', $parcel->batch_no ) }}"   class="btn btn-sm btn-primary"><em class="icon ni ni-eye-alt"></em></a></li>
                                                </ul>
                                            </div>
                                        </div><!-- .nk-tb-item -->
                                        @endforeach

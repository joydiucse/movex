                                    ...
                                    <div class="nk-ecwg nk-ecwg6">
                                        <div class="card-inner">
                                            <div class="card-title-group">
                                                ...
                                                <div class="card-title">
                                                    <h6 class="title">{{($parcel->status == 'delivery-assigned' && $parcel->location != 'dhaka') ? __('in_transit') : __($parcel->status)  }}{{ $parcel->is_partially_delivered ? ('('.__('partially-delivered').')') : '' }}</h6>
                                                </div>
                                                <div class="card-title">
                                                    <a href="{{ Sentinel::getUser()->user_type == 'merchant' ? route('merchant.parcel.print',$parcel->id) : route('merchant.staff.parcel.print',$parcel->id) }}" target="_blank"

...
class CustomerParcelSmsSeeder extends Seeder
{
    /**
...
(6, 'parcel_transferred_to_hub_assigned_event', 'Your parcel {parcel_id} has been assigned to transfer on another hub.\r\n{our_company_name}', 0, NULL, NULL),
(7, 'parcel_transferred_to_hub_event', 'Your parcel {parcel_id} has been successfully transfer on another hub.\r\n{our_company_name}', 0, NULL, NULL),
...
(11, 'parcel_return_to_greenx_event', 'Your parcel {parcel_id} from {merchant_name} has been return to {our_company_name} at {current_date_time}.\r\n{our_company_name}', 0, NULL, NULL),

        ...
        <div class="container-fluid">
            <div class="nk-content-inner">
                <div class="nk-content-body">
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">{{__('submit').' '.__('payment_request')}}</h3>
                    ...
                    <form action="{{ Sentinel::getUser()->user_type == 'merchant' ? route('merchant.withdraw.store') : route('merchant.staff.withdraw.store')}}" class="form-validate" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                                        ...
                                        <div class="row g-gs">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input type="text" name="merchant" hidden value="{{ Sentinel::getUser()->user_type == 'merchant' ? Sentinel::getUser()->merchant->id : Sentinel::getUser()->merchant_id }}">
                                                    <label class="form-label" for="amount">{{__('amount').' ('.__('tk')}})</label>
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="amount" value="{{ number_format($current_payable, 2, '.', '') }}" placeholder="{{ __('amount') }}" required readonly>
                                                    </div>
                                        ...
                                        <div class="row g-gs">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" value="{{ number_format($current_payable, 2, '.', '') }}" name="amount" hidden>
                                                    ...
                                                    @foreach($merchant_accounts as $merchant_account)
                                                        <input type="text" value="{{ $merchant_account->id }}" name="merchant_accounts[]" hidden>
                                                    @endforeach

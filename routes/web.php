    ...
    Route::group(
        ...
        Route::middleware(['LoginCheck'])->group(function () {
            ...
            Route::prefix('admin')->group(function () {
                ...
                Route::post('update-percel/add-pathao-delivery-area/{parcelId}', [ParcelController::class, 'updatePathaoDeliveryArea'])->name('admin.parcel.update.pathao-delivery-area');

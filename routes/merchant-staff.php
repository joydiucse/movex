...
Route::group(['middleware'=>'XSS'], function() {
    Route::middleware(['LoginCheckMerchantStaff'])->group(function (){
        ...
        Route::post('merchant.name.request', [ProfileController::class, 'NameRequest'])->name('merchant.staff.name.request');
        ...
        Route::get('shop-name-request', [ProfileController::class, 'shopName'])->name('shop-name-request');
        Route::post('merchant.update.shop-name', [ProfileController::class, 'shopNameRequest'])->name('merchant.staff.update.shop_name');
        Route::get('shop-change-history', [ProfileController::class, 'shopHistory'])->name('shop-change-history');

                                        ...
                                        <table class="table table-striped">
                                            ...
                                            @foreach ($parcels as $key => $parcel)
                                                <tr>
                                                    ...
                                                    <td scope="col" width="15%">{{ (@$parcel->merchant_id == 1802 && $parcel->user->user_type == 'merchant_staff' ) ? \Illuminate\Support\Str::limit($parcel->user->first_name.' '.$parcel->user->last_name, 15, $end='..') : \Illuminate\Support\Str::limit($parcel->merchant->company, 15, $end='..') }} <br> {{ $parcel->pickup_shop_phone_number }}</td>
                                                    <td scope="col" width="14%"><img  class="image img-fluid" src="data:image/svg;base64,{{ DNS1D::getBarcodePNG($parcel->parcel_no , 'C93',1,33) }}" alt="barcode"   /></td>
                                                    <td scope="col" width="10%">{{ $parcel->parcel_no }} <br> {{ $parcel->customer_phone_number }}</td>

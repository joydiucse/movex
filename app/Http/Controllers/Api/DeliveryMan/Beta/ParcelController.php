...
class ParcelController extends Controller
{
    ...
    public function cancel(Request $request)
    {
        ...
        try{
            ...
            if ($parcel->status == 'received' || $parcel->status == 'delivered' || $parcel->status == 'delivered-and-verified' || $parcel->status == 'partially-delivered' || $parcel->status == 'returned-to-merchant'):

            	...
            	<div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">{{__('edit')}} {{__('user')}}</h3>
		                        ...
		                        <div class="row g-gs">
		                            <div class="col-md-12">
		                                <div class="form-group">
		                                    ...
		                                    <div class="form-control-wrap">
		                                        <input type="text" class="form-control" id="fv-full-name" name="first_name" required value="{{$user->first_name}}">
		                                    </div>
									...
									<div class="col-md-12">
		                                <div class="form-group">
		                                    ...
		                                    <div class="form-control-wrap">
		                                        <input type="text" class="form-control" id="fv-full-name" name="last_name" value="{{$user->last_name}}">
		                                    </div>
		                            ...
		                            <div class="col-md-12">
		                                <div class="form-group">
		                                    ...
		                                    <div class="form-control-wrap">
		                                        <input type="email" class="form-control" id="fv-email" name="email" required value="{{$user->email}}">
		                                    </div>
		                                    @if($errors->has('email'))
	                                            <div class="nk-block-des text-danger">
                                            ...
                                            <div class="form-control-wrap ">
                                                <div class="form-control-select">
                                                    <select class="form-control" id="hub" name="hub">
                                                        ...
                                                        @foreach($hubs as $hub)
                                                            <option value="{{$hub->id}}" {{ old('hub') ? ($hub->id == old('hub') ? 'selected' : '') : ($hub->id == $user->hub_id ? 'selected' : '') }}>{{$hub->name.' ('.$hub->address.')'}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                @if($errors->has('hub'))
										  ...
										  <td>
											@foreach($permission->keywords as $key=>$keyword)
											  <div class="custom-control custom-checkbox">
												@if($keyword != "")
												<input type="checkbox" class="custom-control-input read" id="{{$keyword}}" name="permissions[]" value="{{$keyword}}" {{in_array($keyword, $role_permissions)? 'checked':''}}>

...
namespace App\Http\Controllers\Api\DeliveryMan\V12;
    ...
    public function parceldelivery(Request $request)
    {
        ...
        try{
            ...
            if($otp_permission->value == trim('all')):
                ...
                return $this->responseWithSuccess(__('successfully_otp_send_to_the_customer'), ["delivery-OTP"=> $otp], 200);
            ...
            elseif($otp_permission->value == trim('conditional')):
                ...
                if($parcel->price <=  $parcel->total_delivery_charge):
                    ...
                    $post_data = new Request(['id' =>$request->id]);
                    return $response =  $this->delivery($post_data);
                endif;
            else:
                $post_data = new Request(['id' =>$request->id]);
                return $response =  $this->delivery($post_data);

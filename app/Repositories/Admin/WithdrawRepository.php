...
//                $previous_withdraw_status          = $merchant_withdraw->status;
                ...
                //updating previously inserted company account data
...
//                endif;
                ...
                //staff account calculation and insertion for processed
                ...
                if ($company_account->receipt != '' || $company_account->transaction_id != ''):
                    $sms_body   = str_replace('{our_company_name}', ($company_account->receipt != '' ? ' Receipt: ' . asset($company_account->receipt) : '') . ($company_account->transaction_id != '' ? ', Transaction ID: ' . $company_account->transaction_id : '') . ' ' . __('app_name'), $sms_body);
                ...
                if ($sms_template->sms_to_merchant):
                    $this->smsSender('payment_processed_event', $merchant_withdraw->merchant->phone_number, $sms_body, $sms_template->masking);
                endif;
            //merchant sms end
            ...
            elseif ($status == "rejected"):
                ...
                if ($sms_template->sms_to_merchant):
                    $this->smsSender('payment_rejected_event', $merchant_withdraw->merchant->phone_number, $sms_body, $sms_template->masking);
                endif;
                //merchant sms end

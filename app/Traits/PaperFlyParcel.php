...
trait PaperFlyParcel {
    ...
    public function updatePaperflyParcel() {
        ...
        try {
            ...
            $parcels = Parcel::whereIn('status', ['received','transferred-received-by-hub', 'delivery-assigned', 're-schedule-delivery'])->where('tracking_number','!=','')->get();
...
//                    if ($track_status->DeliveredTime != '' && $track_status->PartialTime == ''):
//                        $parcel->status = 'delivered';
//                        $this->incomeExpenseManage($parcel);
//                        $this->parcelEvent($parcel, 'parcel_delivered_event', $parcel->delivery_man_id, $track_status->DeliveredTime);
//                    endif;

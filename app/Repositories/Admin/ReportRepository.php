...
class ReportRepository implements ReportInterface {
        ...
        try{
            ...
            if ($request->status != ''):
                ...
                elseif ($request->status == 're-schedule-delivery'):
                    $data[__($request->status)] = $this->eventQuery($start_date, $end_date, $merchant, $request->status);
                elseif ($request->status == 'returned-to-greenx'):
                    $data[__($request->status)] = $this->eventQuery($start_date, $end_date, $merchant, $request->status);
                ...
                $data[__('returned-to-greenx')]     = $this->eventQuery($start_date, $end_date, $merchant, 'returned-to-greenx');
    ...
    public function eventQuery($start_date, $end_date, $merchant, $status)
    {
        ...
        if ($status == "returned-to-greenx" || $status == 'return-assigned-to-merchant' || $status == 'returned-to-merchant') {

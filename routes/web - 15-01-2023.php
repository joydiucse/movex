...
Route::group(
	...
	Route::middleware(['LoginCheck'])->group(function () {
        ...
        Route::prefix('admin')->group(function() {
            ...
            Route::get('merchant-return-add/{batch_no}', [BulkController::class,'returnedit'])->name('merchant.return.eidt')->middleware('PermissionCheck:parcel_read');
           ...
           //bulk delivery asssing list
            ...
            Route::post('bulk-sticker', [ParcelController::class, "bulkStickerPrint"])->name('admin.bulk.sticker-print')->middleware('PermissionCheck:read_all_parcel');
            Route::post('bulk-parcel-print', [ParcelController::class, "bulkParcelPrint"])->name('admin.bulk.parcel-print')->middleware('PermissionCheck:read_all_parcel');

            //return sticker
            Route::post('bulk-return-sticker-print', [ParcelController::class, "bulkReturnSticker"])->name('admin.bulk.return-sticker-print')->middleware('PermissionCheck:read_all_parcel');
            ...
            Route::post('parcel-returned-to-merchant-modal', [ParcelController::class, "marchantReturnModal"])->name('parcel-returned-to-merchant-modal')->middleware('PermissionCheck:read_all_parcel');
            Route::post('parcel-delivered-modal', [ParcelController::class, "deliveryModal"])->name('parcel-delivered-modal')->middleware('PermissionCheck:read_all_parcel');

            //delivery otp code
            Route::post('delivery-otp-generate', [ParcelController::class, "deliveryOtpRequest"])->name('delivery-otp-generate')->middleware('PermissionCheck:read_all_parcel');

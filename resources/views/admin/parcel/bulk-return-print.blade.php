        ...
        <div class="nk-main print">
            <div class="nk-content">
                <div class="nk-content-inner">
                    <div class="nk-block">
                        <div class="row g-gs">
                            @foreach ($merchant_return as $parcel)
                                @php $val++ @endphp
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="text-right">
                                                                    @if(isset($parcel['merchant_info']->user->image->image_small_two) && $parcel['merchant_info']->user->image->image_small_two !=null)
                                                                    <img class="img-responsive mt-3"
                                                                        src="{{ asset($parcel['merchant_info']->user->image->image_small_two) }}"
                                                                        alt="{{ $parcel['merchant_info']->user->first_name }}" width="50%">
                                                                    @else
                                                                    <img class="img-responsive mt-3"
                                                                    src=""
                                                                    alt="{{ $parcel['merchant_info']->user->first_name }}" width="50%">
                                                    ...
                                                    <div class="d-inline-flex print-table">
                                                        <table class="merchant-info">
                                                            ...
                                                            <tr>
                                                                <td>{{ __('phone_number') }}
                                                                    :
                                                                    {{ $parcel['merchant_info']['phone_number']  }}
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <table class="table">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <td>: <span class="font-weight-bold pd-3">{{$parcel['total_parcel']}}</span></td>
                                                                    <td> </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>: <span class="font-weight-bold pd-3">{{($parcel['total_cod']) ? $parcel['total_cod'] : 0}} /=</span></td>
                                                                    <td> </td>
                                                                ...
                                                                <tbody>
                                                                @php $sl=1 @endphp
                                                                @foreach($parcel['parcels'] as $single_parcel)
                                                                    <tr>
                                                                    <td>{{$sl++}}</td>
                                                                    <td> {{$single_parcel['Parcel_no']}} </td>
                                                                    <td> {{$single_parcel['customer_invoice_no']}} </td>
                                                                    </tr>
                                                                    @endforeach
                                                                @php $sl=1; @endphp
                                                                </tbody>

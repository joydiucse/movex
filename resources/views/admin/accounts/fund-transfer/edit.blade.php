        ...
        <div class="container-fluid">
            <div class="nk-content-inner">
                <div class="nk-content-body">
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">{{__('edit')}} {{__('fund_transfers')}}</h3>
                    ...
                    <form action="{{ route('admin.fund-transfer.update')}}" class="form-validate" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <select class="form-select form-control form-control-lg account-change" name="from_account" required>
                                                            <option value="">{{ __('select_account') }}</option>

                                                            @foreach($bank_accounts as $account)
                                                                <option value="{{ $account->id }}" {{$account->id == $fund_transfer->from_account_id? 'selected':''}}>
                                                                    ({{__($account->method)}})
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <select class="form-select form-control form-control-lg" name="to_account" required>
                                                            ...
                                                            @foreach($bank_accounts as $account)
                                                                <option value="{{ $account->id }}" {{$account->id == $fund_transfer->to_account_id? 'selected':''}}>
                                                                    ({{__($account->method)}})
                                                                    @if($account->method == 'bank')
                                                                        {{$account->account_holder_name.', '. $account->account_no.', '. __($account->bank_name).','. $account->bank_branch}}.
                                                                    @elseif($account->method == 'cash')
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap focused">
                                                        ...
                                                        <input type="text" class="form-control date-picker" name="date" required autocomplete="off" value="{{isset($fund_transfer->date)? date('m/d/Y', strtotime($fund_transfer->date)): date('m/d/Y')}}">
                                                    </div>
                                                    @if($errors->has('date'))
                                                        <div class="nk-block-des text-danger">
                                        ...
                                        <div class="row g-gs">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="fv-full-name" value="{{ old('amount') != ""? old('amount'): $fund_transfer->StaffTransferAmount->amount }}" name="amount" required>
                                                    </div>

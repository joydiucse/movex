        ...
        <div class="container-fluid">
            <div class="nk-content-inner">
                <div class="nk-content-body">
                    ...
                    <form action="{{ route('merchant.parcel.store')}}" class="form-validate" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            <div class="card-inner">
                                                <div class="row g-gs">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="form-label" for="fv-full-name">{{__('cash_collection')}}({{__('tk')}}) *</label>
                                                            <div class="form-control-wrap">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <select class="form-select form-control form-control-lg select-shop" data-url="{{ route('merchant.shop') }}" name="shop">
                                                                    ...
                                                                    @foreach($shops as $shop)
                                                                        <option value="{{ $shop->id }}">{{ __($shop->shop_name) }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                            @if($errors->has('shop'))
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" id="shop_phone_number" value="{{ old('shop_phone_number') ? old('shop_phone_number'):(@$parcel->pickup_shop_phone_number ? @$parcel->pickup_shop_phone_number : '') }}" name="shop_phone_number" placeholder="{{__('pickup_number')}}">
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" id="shop_address" value="{{ old('shop_address') ? old('shop_address'):(@$parcel->pickup_address ? @$parcel->pickup_address : '') }}" name="shop_address" placeholder="{{__('pickup_address')}}">
                                                            </div>
                                                                 ...
                                                                 <div class="form-group">
                                                                     <div class="preview-block">
                                                                         <div class="custom-control custom-checkbox">
                                                                             <input type="checkbox" class="custom-control-input" id="fragile" name="fragile" {{isset($parcel)? ($parcel->fragile == 1? 'checked':''):''}}>

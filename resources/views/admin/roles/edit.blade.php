            	...
            	<div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">{{__('edit')}} {{__('role')}}</h3>
		                        ...
		                        <div class="row g-gs">
		                            <div class="col-md-12">
		                                <div class="form-group">
		                                    ...
		                                    <div class="form-control-wrap">
		                                        <input type="text" class="form-control" id="fv-full-name" value="{{ $role->name }}" name="name" required>
		                                    </div>
		                                    @if($errors->has('name'))
		                            ...
		                            <div class="col-md-12">
		                                <div class="form-group">
		                                    ...
		                                    <div class="form-control-wrap">
		                                        <input type="text" class="form-control" id="fv-email" value="{{ $role->slug }}" name="slug">
		                                    </div>
		                                    @if($errors->has('slug'))
	                                            <div class="nk-block-des text-danger">
								      ...
								      <td>
										@foreach($permission->keywords as $key=>$keyword)
								      	<div class="custom-control custom-checkbox">
								      		@if($keyword != "")
	                                        <input type="checkbox" class="custom-control-input read common-key" name="permissions[]" value="{{$keyword}}" id="{{$keyword}}" {{ in_array($keyword, $role->permissions)? 'checked':''}}>

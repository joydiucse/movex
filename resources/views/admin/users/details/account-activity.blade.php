                                ...
                                <div class="nk-block card">
                                    <table class="table table-ulogs">
                                        <thead class="thead-light">
                                            <tr>
                                                <th class="tb-col-os"><span class="overline-title">{{__('browser')}}</span></th>
                                                <th class="tb-col-os"><span class="overline-title">{{__('platform')}}</span></th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="tb-col-os">{{$login_activity->platform}}</td>
                                                <td class="tb-col-ip"><span class="sub-text">{{$login_activity->ip}}</span></td>
                                                <td class="tb-col-time"><span class="sub-text">{{$login_activity->created_at != ""? date('M d, Y h:i a', strtotime($login_activity->created_at)):''}}</span></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>

                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">{{__('add_return_parcel')}}</h3>
                                        ...
                                        <div class="row g-gs">
                                            ...
                                            <div class="nk-tb-list nk-tb-ulist">
                                                <div class="nk-tb-item nk-tb-head">
                                                    ...
                                                    <div class="nk-tb-col">
                                                        <span class="sub-text"><strong class="text-info">{{__('phone_number')}}: {{ (hasPermission('merchant_read_phone')) ? $merchant->phone_number : Str::mask($merchant->phone_number, "*", 3).Str::substr($merchant->phone_number, -2) }}</strong></span>
                                                        <span class="sub-text"><strong class="text-success">Return Man Phone : {{ $delivery_man->phone_number }}</strong></span>
                                                    </div>
                                                    <div class="nk-tb-col">
                                                        <span class="sub-text"><strong class="text-info">{{__('address')}} :  {{ (hasPermission('merchant_read_address'))  ? $merchant->address : Str::mask($merchant->address, "*", 3) }}</strong></span>

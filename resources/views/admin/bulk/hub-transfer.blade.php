        ...
        <div class="container-fluid">
            <div class="nk-content-inner">
                <div class="nk-content-body">
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">{{__('hub_transfer')}}</h3>
                    ...
                    <form action="{{ route('bulk.transfer.parcel.save')}}" class="form-validate" id="parcel-form" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card-inner">
                                        <div class="row g-gs">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control barcode" id="barcode" data-url="admin/add-transfer-parcel-row/" value="{{ old('barcode') }}" name="barcode">
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label">{{ __('hub') }} *</label>
                                                    <div class="form-control-wrap">
                                                       <select class="form-select form-control form-control-lg" id="hub" data-url="{{ route('admin.merchant.parcel') }}" name="hub" required>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label">{{ __('shuttle_man') }} *</label>
                                                    <div class="form-control-wrap">

                            ...
                            <div class="card-inner card-inner-lg">
                                <div class="nk-block-head nk-block-head-lg">
                                    <div class="nk-block-between">
                                        ...
                                        <div class="d-flex">
                                            <a href="{{route('delivery.man.edit', $delivery_man->id)}}"  class="btn btn-primary d-md-inline-flex"><em class="icon ni ni-edit"></em><span>{{__('edit')}}</span></a>
                                    ...
                                    <div class="nk-data data-list">
                                        ...
                                        <div class="data-item" data-toggle="modal" data-target="#profile-edit">
                                            <div class="data-col">
                                                ...
                                                <span class="data-value">{{$delivery_man->user->first_name.' '.$delivery_man->user->last_name}}</span>
                                            </div>
                                        </div><!-- data-item -->
                                        ...
                                        <div class="data-item">
                                            <div class="data-col">
                                                ...
                                                <span class="data-value">{{$delivery_man->user->email}}</span>
                                            </div>
                                        </div><!-- data-item -->
                                        <div class="data-item">
                                            <div class="data-col">
                                                <span class="data-label">{{__('phone')}}</span>
                                                <span class="data-value">{{$delivery_man->phone_number}}</span>
                                            </div>
                                        </div><!-- data-item -->
                                        <div class="data-item">
                                            <div class="data-col">
                                                <span class="data-label">{{__('driving_license')}}</span>
                                                <span>
                                        ...
                                        <div class="data-item">
                                            <div class="data-col">
                                                <span class="data-label">{{__('current_amount')}}</span>
                                                <span class="data-value">{{$delivery_man->balance($delivery_man->id) .' '.__('tk')}}</span>
                                            </div>
                                        </div><!-- data-item -->
                                        ...
                                        <div class="data-item">
                                            <div class="data-col">
                                                ...
                                                <span class="data-value">
                                                    @if($delivery_man->user->status == 0)
                                                        <span class="tb-status text-info">{{__('inactive')}}</span>
                                                    @elseif($delivery_man->user->status == 1)
                                        ...
                                        <div class="data-item">
                                            <div class="data-col">
                                                ...
                                                <span class="data-value">{{$delivery_man->user->last_login != ""? date('M y, Y h:i a', strtotime($delivery_man->user->last_login)):''}}</span>
                                            </div>
                                        </div><!-- data-item -->
                                    </div><!-- data-list -->
                                </div><!-- .nk-block -->

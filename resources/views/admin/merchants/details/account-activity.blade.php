                            ...
                            <div class="card-inner card-inner-lg">
                                <div class="nk-block-head nk-block-head-lg">
                                    <div class="nk-block-between">
                                        ...
                                        <div class="d-flex">
                                            <a href="javascript:void(0);" onclick="logout_user_devices('logout-user-all-devices/', {{$merchant->user->id}})"  class="btn btn-primary d-md-inline-flex"><em class="icon ni ni-signout"></em><span>{{__('logout_from_all_devices')}}</span></a>
                                        </div>
                                    </div>
                                </div><!-- .nk-block-head -->

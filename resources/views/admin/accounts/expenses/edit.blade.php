        ...
        <div class="container-fluid">
            <div class="nk-content-inner">
                <div class="nk-content-body">
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">{{__('edit')}} {{__('expense')}}</h3>
                    ...
                    <form action="{{ route('expenses.update')}}" class="form-validate" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="col-md-12">
                                    <div class="card-inner">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <textarea class="form-control" id="details" required placeholder="{{__('title')}}/{{__('details')}}" name="details">{{ old('details') != ""? old('title'):$expense->details }}</textarea>
                                                    </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap focused">
                                                        ...
                                                        <input type="text" class="form-control date-picker" name="date" required autocomplete="off" value="{{old('date') != ""? old('date'):date('m/d/Y', strtotime($expense->date))}}">
                                                    </div>
                                                    @if($errors->has('date'))
                                                        <div class="nk-block-des text-danger">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="nk-block-des text-success">
                                                        <p>{{ __('current_payable_balance') }}: <span id="current-balance">{{$balance}}</span>{{__('tk')}}</p>
                                                        <input type="number" hidden name="payable_balance" id="payable_balance" value="{{$balance}}">
                                                    </div>
                                        ...
                                        <div class="row g-gs">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="fv-full-name" value="{{ old('amount') != ""? old('amount'): abs($expense->amount) }}" name="amount" required>
                                                    </div>
                                        ...
                                        <div class="row g-gs">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control expense-amount" id="transaction_id" value="{{ old('transaction_id') != '' ? old('transaction_id') : $expense->transaction_id}}" name="transaction_id">
                                                    </div>
                                        ...
                                        <div class="row g-gs">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="receipt">{{__('receipt')}}
                                                        @if(!blank($expense->receipt) && file_exists($expense->receipt))
                                                            <a href="{{ asset($expense->receipt) }}" target="_blank"> <em class="icon ni ni-link-alt"></em></a>
                                                        @endif
                                                    </label>
                                                    <div class="form-control-wrap">

                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">{{__('Parcels')}}</h3>
                                ...
                                <div class="card-inner position-relative card-tools-toggle">
                                    ...
                                    <div class="card-title-group">
                                        <div class="card-tools">
                                            <div class="d-block">
                                                <form action="{{ Sentinel::getUser()->user_type == 'merchant' ? route('merchant.parcel') : route('merchant.staff.parcel') }}">
                                                    {{--                                                    @csrf--}}
                                                    {{ __('search') }}
                                        ...
                                        <div class="card-tools mr-n1">
                                            <ul class="btn-toolbar gx-1">
                                                <li>
                                                    <form action="{{Sentinel::getUser()->user_type == 'merchant' ? route('merchant.parcel.filter') : route('merchant.staff.parcel.filter')}}" method="GET">
{{--                                                        @csrf--}}
                                                        <ul class="btn-toolbar gx-1">
                                                            <li>
                                                                <div class="dropdown">
